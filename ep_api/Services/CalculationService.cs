...
namespace EP_API.Services
{
    ...
    {        
        public void PerformCalculations(            
                            APIInputModel inputModel,                                                         
                            out PredictionModel predictionModel
                            )
        {
            predictionModel = new PredictionModel();
            
            if (inputModel.requestedEngines.Contains(EPStandardDefinitions.Engines.QRisk3.ToString()))
            {
                ...
                var calcInputModel = new QRiskInputModel();
                InputMapper.MapApiInputToCalculatorInput<QRiskInputModel>(inputModel, ref calcInputModel);
